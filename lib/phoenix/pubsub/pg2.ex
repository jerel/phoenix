defmodule Phoenix.PubSub.PG2 do
  ...
  def init(server_name) do
    ...
    pids_table = Module.concat(local_name, Pids)
    ...
    children = [
      worker(Phoenix.PubSub.Local, [local_name, pids_table, gc_name]),
      worker(Phoenix.PubSub.GC, [gc_name, local_name, pids_table]),
